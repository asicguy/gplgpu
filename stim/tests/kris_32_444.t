...
///////////////////////////////////////////////////////////////////////////////
/******************************************************************************/
//    		TASK TO TEST YUV IMAGE (KRIS) IN YUV MODE 444 at 32BBP 
/******************************************************************************/
task kris_32_444;
...
//****SET PACKING MODE FOR LINEAR 1 TO YUV_444 at 32BBP *****
 ...
 //INCLUDE KRIS 444 SOURCE FILE
 `include "/home/homer/rev2/blackbird/naser_run/hb_test_suite/IMAGES/YUV/YUV_444_32/kris444.h"
...
wait_win1_not_busy;
 ...
 save_bitmap_2 (32'h0, 32'h137, 32'hd1, "junk", 32'h0a00, 32) ;
