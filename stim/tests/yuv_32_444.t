...
begin
 ...
 fail_count1= 0; //initialize the fail count
  ...
  $fdisplay(results, "\n*******************************************");
  $fdisplay(results, "            YUV_32_442 TEST START               ");
  $fdisplay(results, "*******************************************\n");
 

 
 REV2_STIM.open_file("hb_test_result/yuv_32_444.res"); //open up the dump result file
...
//****SET PACKING MODE FOR LINEAR 1 TO YUV_444 at 32BBP *****
 ...
 mov_dw (MEM_WR, rbase_w+MW1_CTRL,   32'h28b8_0040, 4'h0, 1);  // MW1_CTRL(32 PACKING , 444)
...
/***********************************/
  ...
  $fdisplay(results, "\n*******************************************");
  $fdisplay(results, "*******************************************");
  $fdisplay(results, "            YUV_32_442 TEST END               ");
  $fdisplay(results, "*******************************************");
  $fdisplay(results, "*******************************************\n");

 
 REV2_STIM.close_file("hb_test_result/yuv_32_444.res"); //close the dump file.
