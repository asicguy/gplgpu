...
///////////////////////////////////////////////////////////////////////////////
/******************************************************************************/
//    		TASK TO TEST YUV IMAGE (LILY) IN 444 MODE at 16 BBP(565)
/******************************************************************************/
task lily_16_565_444;
...
//****SET PACKING MODE FOR LINEAR 1 TO YUV_444 at 16BBP *****
 mov_dw (MEM_WR, rbase_w+MW1_CTRL,   32'h34b8_0040, 4'h0, 1);  // MW1_CTRL(16 PACKING 565 , 444)
