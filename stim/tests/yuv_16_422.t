...
begin
 ...
 fail_count1= 0; //initialize the fail count
  ...
  $fdisplay(results, "\n*******************************************");
  $fdisplay(results, "            YUV_16_422 TEST START               ");
  $fdisplay(results, "*******************************************\n");

 
 REV2_STIM.open_file("hb_test_result/yuv_16_422.res"); //open up the dump result file
...
//****SET PACKING MODE FOR LINEAR 0 TO YUV_422 at 16BBP(555) *****
 ...
 mov_dw (MEM_WR, rbase_w+MW0_CTRL,   32'h2430_0040, 4'h0, 1);  // MW0_CTRL(16 PACKING , 422)
...
//****SET PACKING MODE FOR LINEAR 1 TO YUV_422 at 16BBP (565) *****
 ...
 mov_dw (MEM_WR, rbase_w+MW1_CTRL,   32'h2438_0000, 4'h0, 1);  // MW1_CTRL(16 PACKING , 422)
...
//WRITING TO THE HOST CACHE CONTROL REGISTER
 mov_dw (MEM_WR, rbase_w+8'h50, 32'h0001_8010, 4'h0, 1); //ENABLE COUNTER, ENABLE YUV CACHE MECHANISIM
...
//***********************************/
  ...
  $fdisplay(results, "\n*******************************************");
  $fdisplay(results, "*******************************************");
  $fdisplay(results, "            YUV_16_422 TEST END               ");
  $fdisplay(results, "*******************************************");
  $fdisplay(results, "*******************************************\n");
 

 
 REV2_STIM.close_file("hb_test_result/yuv_16_422.res"); //close the dump file.
