...
module flt_recip_iter
   ...
   assign pipe1 =  (~round_mult1) + 25'h1; //Same as 2 - round_mult1
   // assign pipe1 =  ~mult1[32:8] + 1; //Same as 2 - round_mult1
   ...
   // assign sub2 = ~(mult3[40:15]) + 1; //Same as 2 - pipe2
   assign round_mult3 = mult3[40:15] + mult3[14];
   assign sub2 = ~(round_mult3) + 26'h1; //Same as 2 - pipe2
